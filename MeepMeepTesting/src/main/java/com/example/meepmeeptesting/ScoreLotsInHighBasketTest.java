...
public class ScoreLotsInHighBasketTest {
    ...
    public static void main(String[] args) {
        ...
        Trajectory backUpFromBasket = trajectoryBuilder(trajectoryScore.end())
                .back(20)
                .build();

        Trajectory prepareForPickUpSpikeThree = trajectoryBuilder(backUpFromBasket.end())
        ...
        Trajectory prepareForPickUpSpikeTwo = trajectoryBuilder(backUpFromBasket.end())
        ...
        Trajectory prepareForPickUpSpikeOne = trajectoryBuilder(backUpFromBasket.end())
        ...
        Trajectory parkInObservation = trajectoryBuilder(backUpFromBasket.end())
        ...
        RoadRunnerBotEntity mybot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(start)
                                ...
                                .addTrajectory(backUpFromBasket)
