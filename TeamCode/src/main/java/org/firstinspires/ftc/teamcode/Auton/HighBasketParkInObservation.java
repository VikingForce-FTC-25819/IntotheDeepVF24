...
@Config
@Autonomous(group = "1")
public class HighBasketParkInObservation extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory parkInObsZone = drive.trajectoryBuilder(rotateForPark.end())
                .splineTo(new Vector2d(42,-62), Math.toRadians(90))
                .build();
        ...
        robot.storeRobot();
        drive.followTrajectory(parkInObsZone);
